...
<html>
  ...
  <head>
    <title> Contact | JD Home Cooks </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> JD Home Cooks </span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Telephone Number" required>
          </div>
